...
public class MyPaymentFragment extends BaseFragment {
    ...
    private MyPaymentActivity parentActivity;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (fragmentView == null) {
            fragmentView = inflater.inflate(R.layout.fragment_my_payment, container, false);
            ButterKnife.bind(this, fragmentView);
            parentActivity = (MyPaymentActivity) getActivity();
        }
    ...
    public void onReveal() {
        super.onReveal();
        parentActivity.toolbar_title.setText("我的付款");
